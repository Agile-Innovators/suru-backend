...
class CountriesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Country::create(['name' => 'Panamá', 'iso' => 'PA', 'phone_code' => '+507']);
        ...
        Country::create(['name' => 'Belice', 'iso' => 'BZ', 'phone_code' => '+501']);
        Country::create(['name' => 'México', 'iso' => 'MX', 'phone_code' => '+52']);
        ...
        Country::create(['name' => 'Perú', 'iso' => 'PE', 'phone_code' => '+51']);
        ...
        Country::create(['name' => 'República Dominicana', 'iso' => 'DO', 'phone_code' => '+1-809']);
    }
}
